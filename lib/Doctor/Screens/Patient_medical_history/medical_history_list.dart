...
class MedicalHistoryList extends StatefulWidget {
  final String id;
  final String pname;
  final String dname;
  ...
  @override
  _MedicalHistoryListState createState() => _MedicalHistoryListState();
}

class _MedicalHistoryListState extends State<MedicalHistoryList> {
  @override
